...
from tui.ui.console import print_banner, print_divider
from tui.ui.theme import DEFAULT, Theme
...
class ChatView:
    ...
    def assistant_block(self, text: str) -> None:
        ...
        """
        from tui.ui.markdown import render_markdown
            ...
            async for event in events:
                ...
                if etype == "token":
                    ...
                    if hits:
                        ...
                        self.system_notice(f"retrieved {len(hits)} chunk(s) · {titles}")
                    else:
                    ...
                    if duration is not None:
                        self.console.print(f"[{self.theme.divider}]↳ {duration} ms[/]")
                    break
                elif etype == "error":
                    self.console.out("", end="\n")
                    self.error(
