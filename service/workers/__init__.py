...
Wiring example (CLI long-running ingest)::
    ...
    from service.workers import RedisJobQueue, Worker, JobSpec
...
from service.workers.queue import DEFAULT_QUEUE_NAME, JobSpec, RedisJobQueue
from service.workers.worker import JobHandler, Worker
