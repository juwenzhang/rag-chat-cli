...
from service.knowledge.ingest import DEFAULT_CHUNK_OVERLAP, DEFAULT_CHUNK_SIZE, split_text
...
class FileKnowledgeBase:
    ...
    Implements the :class:`~service.knowledge.base.KnowledgeBase` Protocol so
    :class:`~service.chat.service.ChatService` can use it without knowing
