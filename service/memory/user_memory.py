...
* :class:`UserMemoryStore` — user-bound CRUD over the ``user_memories``
  table. Mirrors :class:`~service.memory.chat_memory.DbChatMemory` in spirit:
...
class UserMemoryStore:
    ...
    async def add(
        ...
        *,
        ...
        from service.db.models import UserMemory
...
class NoopFactExtractor:
    ...
    Lets :class:`~service.chat.service.ChatService` always call the hook
