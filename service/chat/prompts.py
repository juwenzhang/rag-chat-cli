...
free functions in :mod:`service.chat.service` with a single
...
if TYPE_CHECKING:
    ...
    from service.memory.user_memory import UserMemoryEntry
...
_DEFAULT_SYSTEM = (
    "You are a helpful assistant. Be concise, accurate, and admit when you do not know something."
)
...
class PromptBuilder:
    ...
    one per :class:`~service.chat.service.ChatService` and reuse it.
    """
