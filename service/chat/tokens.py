...
The :class:`Tokenizer` Protocol is the seam between :class:`~service.llm.client.LLMClient`
implementations (each provider has a different real tokenizer) and the
context-management helpers in :mod:`service.chat.service` (history summarization,
