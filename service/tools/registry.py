...
:class:`service.chat.service.ChatService` will use:

* :meth:`as_specs` — produces the ``tools=...`` argument for
  :meth:`service.llm.client.LLMClient.chat_stream`.
* :meth:`dispatch` — executes one :class:`service.llm.client.ToolCall` and
  returns a :class:`service.tools.base.ToolResult` (never raises; tool
...
from service.llm.client import ToolCall, ToolSpec
from service.tools.base import Tool, ToolError, ToolResult, tool_to_spec
